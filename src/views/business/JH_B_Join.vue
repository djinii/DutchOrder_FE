...
export default {
  data() {
    return {
      ...
      confirm_mpw: "",
      mtel: "",
      // mgroup_mikey: "102", // 101 개인 102 사업자 103 관리자
      // mgroup_makey: "100",
      // mstatus_mikey: "201", // 201 유효회원 202 탈퇴회원
      // mstatus_makey: "200",
      // hiredate: "",
      isEmailValid: false, // 이메일 유효성 여부 추가
      verificationCode: "",
      termsChecked: false,
  ...
  methods: {
    async submitForm() {
      ...
      try {
        const response = await this.axios.post("/business/join", {
          mname: this.mname,
          memail: this.memail,
          mpw: this.mpw,
          mtel: this.mtel,
          mgroup_makey: "100", // 회원 구분 대분류
          mgroup_mikey: "102", // 회원 구분 중분류 101=개인 / 102=사업자 / 103=관리자
          mstatus_makey: "200", //
          mstatus_mikey: "201", // 계정 상태 구분 중분류:201=생존 / 202=탈퇴
        });
